...
namespace xwcs.core.ui.editors.attributes
{
	...
	public class UserControlPlaceholderEditAttribute : CustomAttribute
	{
		...
		public override void applyRetrievedAttribute(IDataBindingSource src, FieldRetrievedEventArgs e)
		{
			...
			(e.RepositoryItem as RepositoryItemCustomAnyControl).ControlType  = typeof(ControlPlaceHolder);
            ((e.RepositoryItem as RepositoryItemCustomAnyControl).Control as INamedControl).ControlName = ControlName;
            //handle connect
